        ...
        <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              <h1
                data-aos="fade-up"
                className="text-3xl sm:text-4xl font-medium font-cursive"
              >
              ...
              >
                Experience the rich blend of flavors that excites your senses
                and ignites your passion for coffee. Indulge in our premium
                selection, meticulously curated to elevate your coffee
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm tracking-wide">
                    Indulge in the rich flavors and comforting warmth of our
                    teas, tailored for the true connoisseur in you.
                  </p>
                </div>
              </div>
            </div>
